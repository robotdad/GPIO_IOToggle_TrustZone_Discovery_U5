...
# BASED ON c:\source\ewprep\GPIO_IOToggle_TrustZone_Discovery_U5\NonSecure
...
add_custom_target(
    "GPIO_IOToggle_TrustZone_Secure"
    COMMAND ${CMAKE_COMMAND} --build --preset ${PRESET_NAME}
    WORKING_DIRECTORY "${PROJECT_SOURCE_DIR}/..\\Secure"
)

add_dependencies(${TARGET_NAME} "GPIO_IOToggle_TrustZone_Secure")
...
target_compile_definitions(
    ...
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:C>>:STM32U585xx>"
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:C>>:USE_HAL_DRIVER>"
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:C>>:STM32U585xx>"
)
...
target_include_directories(
    ...
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:C>>:${PROJECT_SOURCE_DIR}/..\\Drivers\\BSP\\B-U585I-IOT02A>"
    ...
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:C>>:${PROJECT_SOURCE_DIR}/..\\Drivers\\BSP\\B-U585I-IOT02A>"
